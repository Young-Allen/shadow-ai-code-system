package com.shadow.aicodingsystem.langgraph4j.node.concurrent;

import com.shadow.aicodingsystem.langgraph4j.ai.ImageCollectionPlanService;
...
import static com.shadow.aicodingsystem.utils.SpringContextUtil.*;
...
public class ImagePlanNode {
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            try {
                // 获取图片收集计划服务
                ImageCollectionPlanService planService = getBean(ImageCollectionPlanService.class);
